    ...
    <script>
        function calculateDays() {
            ...
            if (startDate && endDate) {
                const difference = Math.abs(endDate - startDate + 1);
...
""")
    print("""
            <input type="text" class="form-control" id="employeeName" name="empid" value="%s" placeholder="Enter your id">
""" %(Emp))
    print("""
          </div>
          ...
          <div class="form-group">
            ...
            """)
    print("""
            <input type="text" class="form-control" id="employeeid" name="ename"  value="%s" placeholder="Enter your name">
         """%(name))
    print("""
          </div>
